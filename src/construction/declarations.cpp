...
std::string choose_teleporter_location_str = "Ye must choose tha location of thy teleporter.";
SDL_Surface* choose_teleporter_location_spr = NULL;
...
bool construction_teleporter_location_select = false; //Is the game waiting for the user to select where to place the teleporter construction?
